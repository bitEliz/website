  ...
  .g-loading {
    ...
    .loader {
      ...
      &::before {
        ...
        animation: dot-rect-frames var(--duration) cubic-bezier(0.785, 0.135, 0.15, 0.86) infinite;
      }
      ...
      svg {
        ...
        circle {
          ...
          animation: path-circle-frames var(--duration) cubic-bezier(0.785, 0.135, 0.15, 0.86)
            infinite;
        }
        ...
        polygon {
          ...
          stroke-dashoffset: 0;
          animation: path-triangle-frames var(--duration) cubic-bezier(0.785, 0.135, 0.15, 0.86)
            infinite;
        }
        ...
        rect {
          ...
          stroke-dashoffset: 0;
          animation: path-rect-frames 3s cubic-bezier(0.785, 0.135, 0.15, 0.86) infinite;
        }
      ...
      &.triangle {
        ...
        &::before {
          ...
          animation: dot-triangle-frames var(--duration) cubic-bezier(0.785, 0.135, 0.15, 0.86)
            infinite;
        }
      }
    }
